...
PLAYER = {
    ...
    "up": [images.spacesuit_up,
            images.spacesuit_up_1,
            images.spacesuit_up_2, 
            images.spacesuit_up_3,
            images.spacesuit_up_4
            ],
    "down": [images.spacesuit_down,
            images.spacesuit_down_1,
            images.spacesuit_down_2, 
            images.spacesuit_down_3,
            images.spacesuit_down_4
            ]
}
...
player_offset_x, playeroffset_y = 0, 0 
...
# SCENERY - objects that cannot be moved between rooms
...
for key, room_scenery_list in scenery.items():
    for scenery_item_list in room_scenery_list:
        check_sum += (scenery_item_list[0] * key
...
assert check_sum == 200095, "Error in scenery data"
print("Scenery checksum: " + str(check_sum))

# placing scenery outside rooms 1-25

for room in range(1, 26): 
    if room != 13:
        scenery_item = random.choice([16, 28, 29, 30])
        scenery[room] = [[scenery_item_list, random.randint(2, 10),
                        random.randint(2, 10)]]
